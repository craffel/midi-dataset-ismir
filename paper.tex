...
In order to apply this technique, we also need to obtain the collections of pairs similar and dissimilar feature vectors $\mathcal{P}$ and $\mathcal{N}$.
In our problem, our two feature modalities are CQTs from synthesized MIDI files and CQTs from audio files.
A logical choice for $\mathcal{P}$ is to choose pairs of constant-Q spectra from simultaneous beats in successfully aligned MIDI/audio pairs.
...
\begin{figure}[h!]
  ...
  \centering
    \includegraphics[width=0.5\textwidth]{percent_below_rank.png}
...
\begin{figure}[h!]
  ...
  \centering
    \includegraphics[width=0.5\textwidth]{rank_vs_score.png}
